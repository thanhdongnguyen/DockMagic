...
#ifndef DOCKMAGIC_SWIFT_H
#define DOCKMAGIC_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="DockMagic",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class NSApplication;
SWIFT_CLASS("_TtC9DockMagic11AppDelegate")
...
@class CLLocation;
SWIFT_CLASS("_TtC9DockMagic37CoreLocationWeatherCoordinateProvider")
@interface CoreLocationWeatherCoordinateProvider : NSObject <CLLocationManagerDelegate>
